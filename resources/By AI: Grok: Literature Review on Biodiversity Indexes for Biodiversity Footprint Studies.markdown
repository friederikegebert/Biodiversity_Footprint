# Literature Review: Biodiversity Indexes Used for Biodiversity Footprint Studies
...
### 3.1 Mean Species Abundance (MSA)
...
| **Tool/Framework**                     | **Primary Index** | **Description**                                                                 | **Source**                                                                 |
|----------------------------------------|-------------------|---------------------------------------------------------------------------------|---------------------------------------------------------------------------|
